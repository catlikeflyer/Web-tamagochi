...
const gameState = {
  ...
  die() {
    ...
    (0, _ui.modFox)('dead');
    this.clearTime();
    (0, _ui.writeModal)("The fox died : ( <br> Press the button to restart");
  }
...
const toggleHighlighted = (icon, show) => document.querySelector(`.${_constants.ICONS[icon]}-icon`).classList[show ? "add" : "remove"]("highlighted");
